      ...
      <div v-show="showSearch" class="search">
        <el-form ref="queryFormRef" :model="queryParams" :inline="true">
          ...
          <el-form-item prop="endLeaveDays">
            <el-input v-model="queryParams.endLeaveDays" placeholder="请输入出差天数" clearable @keyup.enter="handleQuery" />
          </el-form-item>
          <el-form-item>
...
import { delLeave, listLeave } from '@/api/workflow/business';
...
const handleAdd = () => {
  ...
  proxy.$router.push({
    path: `/workflow/businessEdit/index`,
    query: {
      type: 'add'
    }
  });
