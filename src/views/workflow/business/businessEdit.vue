  ...
  <div class="p-2">
    ...
    <el-card shadow="never" style="height: 78vh; overflow-y: auto">
      <el-form ref="leaveFormRef" v-loading="loading" :disabled="routeParams.type === 'view'" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="出差类型" prop="leaveType">
          <el-select v-model="form.leaveType" placeholder="请选择出差类型" style="width: 100%">
        ...
        <el-form-item label="出差天数" prop="leaveDays">
          <el-input v-model="form.leaveDays" disabled type="number" placeholder="请输入出差天数" />
        </el-form-item>
        <el-form-item label="出差原因" prop="remark">
          <el-input v-model="form.remark" type="textarea" :rows="3" placeholder="请输入出差原因" />
        </el-form-item>
      </el-form>
    </el-card>
    <!-- 提交组件 -->
...
import { addLeave, getLeave, updateLeave } from '@/api/workflow/business';
import { LeaveForm, LeaveQuery, LeaveVO } from '@/api/workflow/business/types';
