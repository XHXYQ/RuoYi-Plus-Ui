  ...
  <div class="employee-management">
    ...
    <div class="employee-table">
      ...
      >
        ...
        <el-table-column prop="startDate" label="预计离职日期" min-width="120">
          <template #default="{ row }">
            {{ formatDate(row.startDate) }}
          </template>
        </el-table-column>
        <el-table-column label="离职原因" align="center" prop="remark" />
        <el-table-column label="操作" width="120" fixed="right">
          <template #header>
            <span>操作</span>
          </template>
          <template #default="{ row }">
            <el-button type="text">确认离职</el-button>
            <el-button type="text" @click="">撤销</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      ...
      >
        ...
        <el-form-item label="预计离职时间" prop="startDate">
          <el-date-picker
            v-model="addForm.startDate"
            type="date"
            placeholder="预计离职日期"
